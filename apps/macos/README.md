...
```sh
./scripts/release_macos.sh 0.16.13 --local
open dist/macos/MachBoost-0.16.13-arm64.dmg
```
...
./scripts/release_macos.sh 0.16.13
./scripts/publish_macos_release.sh 0.16.13 ./release-notes/0.16.13.md
```
...
signed Sparkle appcast. The publisher requires an existing `v0.16.13` tag, an
