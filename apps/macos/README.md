...
```sh
./scripts/release_macos.sh 0.16.12 --local
open dist/macos/MachBoost-0.16.12-arm64.dmg
```
...
./scripts/release_macos.sh 0.16.12
./scripts/publish_macos_release.sh 0.16.12 ./release-notes/0.16.12.md
```
...
signed Sparkle appcast. The publisher requires an existing `v0.16.12` tag, an
