...
```sh
python3 -m pip install "machboost[mlx] @ git+https://github.com/VistritPandey/machboost.git@v0.16.14"
python3 -m pip install "machboost[vision] @ git+https://github.com/VistritPandey/machboost.git@v0.16.14"
python3 -m pip install "machboost[dflash] @ git+https://github.com/VistritPandey/machboost.git@v0.16.14"
```
